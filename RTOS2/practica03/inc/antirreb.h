...
/** @brief largo de la cola de datos de flancos validados */
#define QUEUE_FLANCOS_VALIDADOS_L   4
/* ========================== [ definicion de tipos de datos ] ======================= */

/** @brief enumeracion de estados de la maquina de estados de antirrebote */
typedef enum {BOTON_INACTIVO, BUTTON_UP, BUTTON_FALLING, BUTTON_DOWN, BUTTON_RAISING} antirreboteMEF_t;
...
typedef enum {FBAJADA_VALIDADO, FSUBIDA_VALIDADO} flancoValidado_t;

typedef struct {

  gpioMap_t tecla;
  TickType_t tiempoFlanco;
  flancoValidado_t flancoV;
} teclaFlanco_t;


/* ========================== [ funciones externas ] ======================= */

extern int inicializarQueuesFlancosyTeclas ( void );
...
extern QueueHandle_t queueFlancosValidados;
